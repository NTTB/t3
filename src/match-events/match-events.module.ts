...
import {
  ...
  ChangeGameStateMatchEventSchema,
  ChangeScoreMatchEvent,
  ChangeScoreMatchEventSchema,
  ChangeServiceMatchEvent,
  ChangeServiceMatchEventSchema,
  MatchEvent,
  MatchEventSchema,
  TimeOutMatchEvent,
  TimeOutMatchEventSchema,
    ...
    MongooseModule.forFeature([
      {
        ...
        discriminators: [
          {
            name: ChangeScoreMatchEvent.name,
            schema: ChangeScoreMatchEventSchema,
          },
          {
            name: ChangeServiceMatchEvent.name,
            schema: ChangeServiceMatchEventSchema,
          },
          { name: TimeOutMatchEvent.name, schema: TimeOutMatchEventSchema },
          {
            name: ChangeGameStateMatchEvent.name,
            schema: ChangeGameStateMatchEventSchema,
          },
        ],
      },
    ]),
